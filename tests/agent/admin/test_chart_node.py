...
def test_chart_agent_uses_chart_tools_and_writes_result(monkeypatch):
    ...
    def fake_invoke_with_failure_policy(*, llm, messages, tools=None, **_kwargs):
        _ = llm
    ...
    monkeypatch.setattr(chart_node_module, "invoke_with_failure_policy", fake_invoke_with_failure_policy)
...
def test_chart_agent_returns_fallback_and_failed_step_output_when_llm_fails(monkeypatch):
    def fake_invoke_with_failure_policy(*_args, **_kwargs):
