...
- `consultation_agent`：用户想判断自己是什么情况、怀疑自己得了什么常见病、想让你先做症状分诊、想根据当前症状推荐常见药品，以及问诊链路中的后续补充回答。
...
- “我是不是感冒了 / 我这是怎么了 / 帮我看看我是什么情况 / 我咳嗽流鼻涕该吃什么” -> `consultation_agent`
- 如果最近几轮已经在追问病情，用户这轮只是继续补充症状或回答上一个问诊问题，也继续返回 `consultation_agent`
