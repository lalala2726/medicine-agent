...
_SUMMARY_UPDATE_PROMPT = load_prompt("_system/summary_update.md").strip()
_SUMMARY_COMPRESS_PROMPT = load_prompt("_system/summary_compress.md").strip()
...
def _truncate_text_by_tokens(
    ...
    try:
        ...
        encoder = TokenUtils._get_encoder()
...
def _enforce_summary_token_budget(
    ...
    compressed_candidate = _call_summary_llm(
        system_prompt=_SUMMARY_COMPRESS_PROMPT,
...
def refresh_conversation_summary_if_needed(
    ...
    try:
        ...
        generated_summary = _call_summary_llm(
            system_prompt=_SUMMARY_UPDATE_PROMPT,
