...
_OPENAI_SUMMARY_MODEL_ENV = "OPENAI_SUMMARY_MODEL"
_DASHSCOPE_SUMMARY_MODEL_ENV = "DASHSCOPE_SUMMARY_MODEL"
_VOLCENGINE_SUMMARY_MODEL_ENV = "VOLCENGINE_LLM_SUMMARY_MODEL"
...
def resolve_assistant_summary_model() -> str | None:
    ...
    返回值：
        str | None:
            ...
            1. 当前厂商专属环境变量：
               ...
               - aliyun: `DASHSCOPE_SUMMARY_MODEL`
               - volcengine: `VOLCENGINE_LLM_SUMMARY_MODEL`
    ...
    provider_summary_model_env = {
        LlmProvider.OPENAI: _OPENAI_SUMMARY_MODEL_ENV,
        LlmProvider.ALIYUN: _DASHSCOPE_SUMMARY_MODEL_ENV,
        LlmProvider.VOLCENGINE: _VOLCENGINE_SUMMARY_MODEL_ENV,
    }[resolved_provider]
...
def _to_chat_memory_messages(
    ...
    for document in documents:
        if document.role == MessageRole.USER:
            result.append(HumanMessage(content=document.content))
        else:
