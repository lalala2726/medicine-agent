...
from app.agent.admin.domain.product.tools import (
    get_drug_detail,
    get_product_detail,
    get_product_list,
)
...
_PRODUCT_NODE_SYSTEM_PROMPT = load_prompt("admin/product_node_system_prompt.md")


@traceable(name="Admin Assistant Product Agent Node", run_type="chain")
